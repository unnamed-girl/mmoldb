...
pub fn event_to_row<'e>(
    ...
    NewEvent {
        ...
        home_score_before: event.home_score_before as i32,
        home_score_after: event.home_score_after as i32,
        away_score_before: event.away_score_before as i32,
        away_score_after: event.away_score_after as i32,
...
pub fn row_to_event<'e>(
    ...
    Ok(EventDetail {
        ...
        outs_before: event.outs_before,
        outs_after: event.outs_after,
        home_score_before: event.home_score_before as u8,
        home_score_after: event.home_score_after as u8,
        away_score_before: event.away_score_before as u8,
        away_score_after: event.away_score_after as u8,
        batter_name: event.batter_name,
        pitcher_name: event.pitcher_name,
        detail_type: taxa
